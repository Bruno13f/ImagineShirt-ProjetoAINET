            ...
            <div class="col-md-5 col-xl-4" style = "margin-bottom: 20px">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Definições Perfil</h5>
                    </div>
                                ...
                                <form>
                                    ...
                                    <div class="row" style="margin-top: 10px">
                                        <div class="col-md-12 justify-content-center" style = "display:flex">
                                            <button type="submit" class="btn btn-primary" style="background-color:rgba(230, 51, 52, 0.8); border-color: rgba(230, 51, 52, 0.8)" >Guardar</button>   
                                        </div> 
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="inputAddress">Referência de Pagamento</label>
                                            <input type="text" class="form-control" id="inputAddress" placeholder="se paypal = email ; se MC ou Visa = numCartao">
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px">
                                        <div class="col-md-12 justify-content-center" style = "display:flex">
