                        ...
                        <table class="table table-hover table-bordered table-light">
                            <tbody>
                                <div class="d-flex justify-content-center mb-4">
                                    <a href=""><button type="button" class="btn btn-success rounded-pill"><span>Criar Categoria</span></button></a></a>
                                </div>
                                @foreach($categorias as $categoria)
                                    <tr>
                                        <td><span class="fs-5">{{$categoria->name}}</span></td>
                                        <td>
                                            <a href=""><button type="button" class="btn btn-info rounded-pill"><span>Editar</span></button></a></a>
                                            <a href=""><button type="button" class="btn btn-danger rounded-pill"><span>Eliminar</span></button></a></a>
                                        </td>
                                    </tr>
                                @endforeach                            
                            </tbody>
